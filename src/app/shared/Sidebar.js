    ...
    return (
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        <ul className="nav">
          <li
            className={
              this.isPathActive("/listProvider")
                ? "nav-item active"
                : "nav-item"
            }
          >
            <Link className="nav-link" to="listProvider">
              <span className="menu-title">
                <Trans>Nhà cung cấp</Trans>
              </span>
          ...
          <li
            className={
              this.isPathActive("/listService") ? "nav-item active" : "nav-item"
            }
          >
            <Link className="nav-link" to="listService">
              <span className="menu-title">
                <Trans>Danh sách dịch vụ</Trans>
              </span>
              <i className="mdi mdi-home menu-icon"></i>
            </Link>
          </li>
